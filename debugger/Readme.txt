...
Usage: Download payload.swf and place it in the same directory as your SM63 executable. Create a new level designer level,
place a sign and enter either <img src="http://jhynjhiruu.uk/sm63db/a.swf"> if you want to use form a or <img src="http://jhynjhiruu.uk/sm63db/b.swf"> if you want to use form b. Premade level codes are available at http://jhynjhiruu.uk/sm63db/Debugging.txt if you want them.
